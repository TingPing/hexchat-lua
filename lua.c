...
static inline int api_hexchat_list_meta_index_real(lua_State *L, const char *key, hexchat_list *list)
{
...
static int api_hexchat_props_meta_index(lua_State *L)
{
	...
	return api_hexchat_list_meta_index_real(L, key, NULL);
}
...
static int api_list_meta_index(lua_State *L)
{
	...
	return api_hexchat_list_meta_index_real(L, key, list);
}
